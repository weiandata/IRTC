...
{\LightFont\fontsize{10.5}{16}\selectfont\color{white}%
 ...
 软件版本 1.1.1（2026-07-17）\quad · \quad 手册发布 2026 年 8 月\par}
\vspace{0.9cm}
...
\textbf{对应软件} & IRTC 1.1.1，发布日期 2026-07-17\\
...
\textbf{手册版本} & V1.1.1 正式发布版，2026 年 8 月\\
\end{tabular}\par}
...
\textbf{关于版本一致性}\quad 本手册与 IRTC 1.1.1 逐条核对。1.1.1 相对 1.1.0 只做打包修正，
函数、参数与估计结果完全一致，因此手册内容对 1.1.0 同样适用。若手册与包内帮助页
（\IRTColdtexttt{?irtc}、\IRTColdtexttt{?irtc.mml}）出现不一致，以帮助页为准。}
\end{tcolorbox}
...
\textbf{关于这一版。}\quad IRTC 1.1.1 已通过 CRAN 审核并正式上架，
在 R 中运行 \IRTColdtexttt{install.\allowbreak{}packages("IRTC")} 即可安装。
软件的安装、文档与跨平台可用性都已经过 R 社区公开检查。本手册即随这一版本发布。
